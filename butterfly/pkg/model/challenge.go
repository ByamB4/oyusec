...
type Challenge struct {
	...
	State       ChallengeState    `gorm:"constraint:OnDelete:SET NULL;" json:"state,omitempty"`
	...
	Notes       []ChallengeNote   `gorm:"constraint:onDelete:SET NULL;many2many:challenge_note;" json:"notes,omitempty"`
