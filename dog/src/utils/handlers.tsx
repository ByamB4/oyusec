...
export const handleChallengeCategoryIcon = (cat: IChallengeCategory): ReactElement | undefined => {
  switch (cat.key) {
    case 'forensics':
...
export const handleCompetitionsRootTabIcon = (state: ICompetitionState): ReactElement | undefined => {
  switch (state.key) {
    case 'live':
...
export const handleCompetitionTabIcon = (tab: ICompetitionTab): ReactElement | undefined => {
  switch (tab.type.key) {
    case 'about':
...
export const handleCompetitionTabContentIcon = (content: ICompetitionTabContent): ReactElement | undefined => {
