    ...
    >
      ...
      <div className="grid lg:grid-cols-2 h-full">
        ...
        <div className="relative lg:block hidden">
          ...
          <div
            className="xl:flex hidden flex-col bg-primary-light1 items-start lg:visible invisible gap-4 absolute p-4 rounded-xl"
            style={{
              top: `5%`,
              left: `0%`,
            }}
          ...
          <div
            className="bg-primary-light1 xl:flex hidden items-start gap-4 absolute p-4 rounded-xl"
            style={{
              top: `20%`,
              left: `35%`,
            }}
