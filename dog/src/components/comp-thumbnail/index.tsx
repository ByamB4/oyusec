...
const CompetitionThumbnail: React.FC<Props> = ({ className = '', competition }): React.ReactElement => {
  return (
    <Link href={`/competitions/${competition.slug}`}>
      ...
      >
        <Image src={safeCompetitionThumbnail(competition)} height={150} width={300} objectFit="cover" />
